...
<div class="half column"><div class="cell image preload-home" style="background-image:url('<?php echo $image1_src ?>');"><div class="inner"></div></div></div>
    ...
    <section id="result" class="intro white"><h3 class="underline"><?php echo get_field('third_section_heading',$post->ID) ?></h3>
      <?php
      /*
   <?php    
...
<div class="column">
  ...
  <div class="cell image" style="background-image:url('<?php echo $image2_src ?>');"></div>
</div>
<?php endif ?>
    </section>
<footer id="cta" class="intro" style="background-color:<?php echo $colour ?>;"><h3 class="underline"><?php echo get_field('fourth_section_heading',$post->ID) ?></h3><a href="mailto:enquiries@mpdpm.co.uk" class="button">Start your project</a>
</footer>
   </div>
</div>
<?php get_footer() ?>