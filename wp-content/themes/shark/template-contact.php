...
<?php get_header()?>
<div class="section contact" id="<?php echo $post->post_name ?>" data-anchor="<?php echo $post->post_name ?>" data-title="<?php wp_title()?>">
...
<section class="content green"><div class="column-wrap">
<?php
